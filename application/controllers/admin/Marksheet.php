...
class Marksheet extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('heading', $this->lang->line('heading'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('title', $this->lang->line('title'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('exam_name', $this->lang->line('exam')." ".$this->lang->line('name'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('date', $this->lang->line('date'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('school_name', $this->lang->line('school_name'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('exam_center', $this->lang->line('exam')." ".$this->lang->line('center'), 'trim|required|xss_clean');
 ...
 public function edit($id)
    {
        ...
        $this->form_validation->set_rules('exam_name', 'exam_name', 'trim|required|xss_clean');
        $this->form_validation->set_rules('date', 'date', 'trim|required|xss_clean');
        $this->form_validation->set_rules('school_name', 'school_name', 'trim|required|xss_clean');
        $this->form_validation->set_rules('exam_center', 'exam_center', 'trim|required|xss_clean');
        ...
        $this->form_validation->set_rules('background_img', 'background_img', 'callback_handle_upload[background_img]');
         $this->form_validation->set_rules('sign', 'sign', 'callback_handle_upload[sign]');
