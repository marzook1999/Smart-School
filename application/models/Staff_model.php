...
class Staff_model extends MY_Model
{
	...
	public function getTotalStaff(){ 
		...
		$this->db->from("staff_attendance");
		$this->db->where('date = ',$date);
		$this->db->where("(staff_attendance_type_id='1' OR staff_attendance_type_id='2' OR staff_attendance_type_id='3' OR staff_attendance_type_id='4')");
		$this->db->group_by('staff_id'); 
		$query = $this->db->get();
